...
//go:generate mockgen -destination=./mocks/mock_github_fact_collector.go -package=factcollectors github.com/motain/of-catalog/internal/services/factsystem/factcollectors GithubFactCollectorInterface
