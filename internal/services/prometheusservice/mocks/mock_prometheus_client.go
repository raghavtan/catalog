...
func (m *MockPrometheusClientInterface) Query(query string, time time.Time) (model.Value, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Query", query, time)
...
func (mr *MockPrometheusClientInterfaceMockRecorder) Query(query, time any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Query", reflect.TypeOf((*MockPrometheusClientInterface)(nil).Query), query, time)
}
