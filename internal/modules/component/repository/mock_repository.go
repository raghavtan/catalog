...
// Source: github.com/motain/fact-collector/internal/modules/component/repository (interfaces: RepositoryInterface)
...
func (m *MockRepositoryInterface) Create(arg0 context.Context, arg1 resources.Component) (string, error) {
	m.ctrl.T.Helper()
